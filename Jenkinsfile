        ...
        stage ('Deploy') {
            steps{
                scripts {
                    ...
                    --cpu 1 --memory 1 --registry-login-server $(registry_name) 
                    --registry-username owwllFastApiCR  
                    --registry-password L9hhyrtOBwgoB8J0Jw62h8aWTZUsCWvelpAPeY1Oi++ACRB7JmIC 
                    --ip-address Public --dns-name-label owwll-ap-instance --ports 80']], principalCredentialId: '34a5f951-6d0f-4665-ae04-6cc649cdefd9'
                }
            }
        }
}
